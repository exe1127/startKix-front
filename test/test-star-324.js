...
Feature('See their camera');

Scenario(`As a Fan who went on a live with a Star, I want to see their camera, 
be able to change my camera front or back, turn off my camera, mute myself, and leave the call`, ({ I }) => {
    login(I);
    ...
    //falta aceptar el salir y estaria
